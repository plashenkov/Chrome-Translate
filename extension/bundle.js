...
Component.options.__file = "/Users/plashenkov/Documents/Projects/Мои проекты/Chrome-Translate/src/App.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-67f49790", Component.options)
  } else {
    hotAPI.reload("data-v-67f49790", Component.options)
  }
...
function clampPopupWidth(value) {
  return (0, _utils.between)(value, _config2.default.minPopupWidth, _config2.default.maxPopupWidth);
}

function clampPopupHeight(value) {
  return (0, _utils.between)(value, _config2.default.minPopupHeight, _config2.default.maxPopupHeight);
}

function clampInputHeight(value) {
  return (0, _utils.between)(value, _config2.default.minInputHeight, maxInputHeight);
}
...
exports.default = {
  ...
  computed: {
    ...
    targetLanguages: function targetLanguages() {
      return _languages2.default;
    }
  },
  ...
  mounted: function mounted() {
    ...
    (0, _utils.getSelectedText)().then(function (text) {
      if (text) {
        _this.sourceText = text;
      } else {
        _this.sourceText = localStorage.sourceText || '';
      }
  ...
  methods: {
    inputResizerMouseDown: function inputResizerMouseDown(e) {
      var _this2 = this;
      ...
      var mouseMove = function mouseMove(e) {
        _this2.inputHeight = clampInputHeight(inputHeight + e.screenY - mouseCoordinates.y);
      };
      ...
      var mouseUp = function mouseUp() {
        ...
        localStorage.inputHeight = _this2.inputHeight;
      };

      document.addEventListener('mousemove', mouseMove);
      document.addEventListener('mouseup', mouseUp);
    },
    cornerResizerMouseDown: function cornerResizerMouseDown(e) {
      var _this3 = this;
      ...
      var mouseMove = function mouseMove(e) {
        ...
        _this3.popupWidth = clampPopupWidth(popupSize.width + mouseCoordinates.x - e.screenX);
        _this3.popupHeight = clampPopupHeight(popupSize.height - mouseCoordinates.y + e.screenY);
        _this3.inputHeight = clampInputHeight(_this3.inputHeight);
      };
      ...
      var mouseUp = function mouseUp() {
        ...
        localStorage.popupWidth = _this3.popupWidth;
        localStorage.popupHeight = _this3.popupHeight;
      };
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [(_vm.activeTab === 'translate') ? _c('div', {
    ...
    attrs: {
      "options": _vm.sourceLanguages,
      "label": "name",
      "track-by": "code",
      "allow-empty": false,
      "show-labels": false,
      "placeholder": _vm.sourceLanguage.name
    },
    model: {
      value: (_vm.sourceLanguage),
      callback: function($$v) {
        _vm.sourceLanguage = $$v
      },
      expression: "sourceLanguage"
    }
  }), _vm._v(" "), _c('button', {
    staticClass: "button-swap-languages"
  }), _vm._v(" "), _c('multiselect', {
    staticClass: "dropdown-language",
    attrs: {
      "options": _vm.targetLanguages,
      "label": "name",
      "track-by": "code",
      "allow-empty": false,
      "show-labels": false,
      "placeholder": _vm.targetLanguage.name
    },
    model: {
      value: (_vm.targetLanguage),
      callback: function($$v) {
        _vm.targetLanguage = $$v
      },
    ...
    staticClass: "resizer-input",
    on: {
      "mousedown": _vm.inputResizerMouseDown
    }
  }), _vm._v(" "), _vm._m(0)]) : _vm._e(), _vm._v(" "), (_vm.activeTab === 'settings') ? _c('div', {
    staticClass: "tab-content"
  }, [_vm._v("...")]) : _vm._e()]), _vm._v(" "), _c('div', {
    staticClass: "tabs"
  }, [_c('div', {
    staticClass: "tab tab-translate",
    class: {
      'is-active': _vm.activeTab === 'translate'
    },
    on: {
    ...
    staticClass: "resizer-corner",
    on: {
      "mousedown": _vm.cornerResizerMouseDown
    }
  })])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "translation-result-container"
  }, [_c('div', {
    staticClass: "translation-result"
  }), _vm._v(" "), _c('button', {
    staticClass: "button-play"
  })])
}]}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-67f49790", module.exports)
  }
}
